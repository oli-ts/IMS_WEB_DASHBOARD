...
export default function ManifestDetail({ params }) {
    ...
    <div className="space-y-4">
      ...
      <div className="grid gap-2">
        {items.map((mi) => (
          <div
            key={mi.id}
            className="p-3 rounded-xl border dark:border-neutral-800 bg-white dark:bg-neutral-900 flex items-center justify-between"
          >
            <div>
              <div className="font-medium">{mi.item_uid}</div>
