...
export function buildZplForItem(item) {
  ...
  return [
    ...
    `^FO160,40^A0N,28,28^^FB230,2,0,L,0^FD${name}^FS`,
    `^FO160,105^A0N,26,26^^FB230,1,0,L,0^FD${uid}^FS`,
    `^FO160,135^A0N,24,24^^FB230,1,0,L,0^FD${cls}^FS`,
    `^FO160,165^A0N,24,24^^FB230,1,0,L,0^FDAudit: ${safe(auditDate)}^FS`,
    "^XZ",
  ].join("\n");
}
